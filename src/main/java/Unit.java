...
abstract class Unit {
    ...
    protected double getHealthModifier() { return this.healthModifier; }
    protected double getDamage() { return this.damage; }
    protected double getDamageModifier() { return this.damageModifier; }
    protected int getLuck() { return this.luck; }
    protected int getxCor() { return this.xCor; }
    protected int getyCor() { return this.yCor; }
    protected int getMovement() { return this.movement; }
    protected int getMovementModifier() { return this.movementModifier; }
    protected void setTeamColor(String color) { this.teamColor = color; }
    ...
    protected void setHealthModifier(double healthModifier) { this.healthModifier = healthModifier; }
    protected void setDamage(double damage) { this.damage = damage; }
    protected void setDamageModifier(double damageModifier) { this.damageModifier = damageModifier; }
    protected void setLuck(int luck) { this.luck = luck; }
    protected void setxCor(int xCor) { this.xCor = xCor; }
